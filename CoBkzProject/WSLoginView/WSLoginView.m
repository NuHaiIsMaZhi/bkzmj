...
- (void)creatSubViews {
    ...
    self.textField1 = [[UITextField alloc]initWithFrame:CGRectMake(20, CGRectGetMaxY(self.titleLabel.frame)+20, smallView.frame.size.width-40, 40)];
    ...
    self.loginBtn = [[UIButton alloc]initWithFrame:CGRectMake(20, CGRectGetMaxY(self.textField2.frame)+25, smallView.frame.size.width-40, 40)];
...
//    registerBtn.backgroundColor = UIColor.redColor;
    ...
    UIButton *forgentPasswordBtn = [UIButton new];
//    forgentPasswordBtn.backgroundColor = UIColor.redColor;
    forgentPasswordBtn.frame = CGRectMake(self.frame.size.width - 100 - 10, CGRectGetMaxY(smallView.frame)+20, 100, 30);
